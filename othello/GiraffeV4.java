...
public class GiraffeV4 extends AIPlayer {
    @Override
    public String getName() {
        return "Sarah Connor v4";
    }
...
//            throw new InterruptedException();
    ...
    public boolean isCorner(int[] location){
        return (location[0]==0 && location[1]==0) || (location[0]==0 && location[1]==7) || (location[0]==7 && location[1]==0) || (location[0]==7 && location[1]==7);
    }
    @Override
 ...
 */
        ...
        return board.countCells(board.BLACK) + movesBlack + CornerBlack -board.countCells(board.WHITE) - movesWhite - CornerWhite;
    }
